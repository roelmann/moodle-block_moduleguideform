...
$heading = $site->fullname . ' :: ' . $course->shortname . ' :: ' . $modguideformpage->modulecode;
...
if (!$confirm) {
    ...
    echo $OUTPUT->confirm(get_string('deletepage', 'block_modguideform', $modguideformpage->modulecode), $optionsyes, $optionsno);
} else {
    if (confirm_sesskey()) {
